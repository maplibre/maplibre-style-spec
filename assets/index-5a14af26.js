import{g as Pe,a as o,i as n,c as e,t as qe}from"./entry-client-42ca8603.js";import{M as i}from"./markdown-779fb949.js";import{C as P}from"./caption-24075384.js";import{P as a,S as q}from"./property-ffd4f5e9.js";import{S as r}from"./subtitle-cb6674c1.js";const Ce=qe('<div><!#><!/><!#><!/><!#><!/><!#><!/><!#><!/><!#><!/><!#><!/><!#><!/><!#><!/><!#><!/><!#><!/><!#><!/><!#><!/><!#><!/><!#><!/><!#><!/><!#><!/><!#><!/><!#><!/><!#><!/><div class="mb12"></div><!#><!/><a id="types-function-zoom-property" class="anchor"></a><!#><!/><!#><!/><!#><!/><!#><!/>');function He(){return(()=>{const t=Pe(Ce),C=t.firstChild,[l,O]=o(C.nextSibling),E=l.nextSibling,[s,N]=o(E.nextSibling),F=s.nextSibling,[p,B]=o(F.nextSibling),H=p.nextSibling,[u,R]=o(H.nextSibling),Z=u.nextSibling,[c,D]=o(Z.nextSibling),G=c.nextSibling,[h,M]=o(G.nextSibling),U=h.nextSibling,[d,W]=o(U.nextSibling),Y=d.nextSibling,[f,K]=o(Y.nextSibling),J=f.nextSibling,[m,Q]=o(J.nextSibling),V=m.nextSibling,[y,X]=o(V.nextSibling),ee=y.nextSibling,[g,te]=o(ee.nextSibling),ne=g.nextSibling,[b,oe]=o(ne.nextSibling),ie=b.nextSibling,[v,ae]=o(ie.nextSibling),re=v.nextSibling,[$,le]=o(re.nextSibling),se=$.nextSibling,[_,pe]=o(se.nextSibling),ue=_.nextSibling,[x,ce]=o(ue.nextSibling),he=x.nextSibling,[w,de]=o(he.nextSibling),fe=w.nextSibling,[S,me]=o(fe.nextSibling),ye=S.nextSibling,[k,ge]=o(ye.nextSibling),be=k.nextSibling,[z,ve]=o(be.nextSibling),j=z.nextSibling,$e=j.nextSibling,[T,_e]=o($e.nextSibling),xe=T.nextSibling,we=xe.nextSibling,[L,Se]=o(we.nextSibling),ke=L.nextSibling,[A,ze]=o(ke.nextSibling),je=A.nextSibling,[I,Te]=o(je.nextSibling),Le=I.nextSibling,[Ae,Ie]=o(Le.nextSibling);return n(t,e(i,{content:`# Deprecations
...
## Function
`}),l,O),n(t,e(P,{theme:"warning",get children(){return e(i,{get content(){return`
As of [v0.41.0](https://github.com/maplibre/maplibre-gl-js/blob/main/CHANGELOG.md#0410-october-11-2017), [property expressions](/maplibre-style/expressions) is the preferred method for styling features based on zoom level or the feature's properties. Zoom and property functions are still supported, but will be phased out in a future release.
`}})}}),s,N),n(t,e(i,{content:`
...
`}),p,B),n(t,e(a,{headingLevel:"3",id:"function-stops",children:"stops"}),u,R),n(t,e(r,{get children(){return e(i,{get content(){return"Required (except for `identity` functions) [array](/maplibre-style/types/#array)."}})}}),c,D),n(t,e(i,{get content(){return'\nA set of one input value and one output value is a "stop." Stop output values must be literal values (i.e. not functions or expressions), and appropriate for the property. For example, stop output values for a `fill-color` function property must be [colors](/maplibre-style/types/#color).\n'}}),h,M),n(t,e(a,{headingLevel:"3",id:"function-property",children:"property"}),d,W),n(t,e(r,{get children(){return e(i,{get content(){return`
Optional [string](/maplibre-style/types/#string).
`}})}}),f,K),n(t,e(i,{get content(){return`
If specified, the function will take the specified feature property as an input. See [Zoom Functions and Property Functions](/maplibre-style/types/#function-zoom-property) for more information.
`}}),m,Q),n(t,e(a,{headingLevel:"3",id:"function-base",children:"base"}),y,X),n(t,e(r,{get children(){return e(i,{get content(){return`
Optional [number](/maplibre-style/types/#number). Default is ref.function.base.default.
...
`}),_,pe),n(t,e(a,{headingLevel:"3",id:"function-default",children:"default"}),x,ce),n(t,e(i,{content:`
...
: Use the HCL color space to interpolate color values, interpolating the Hue, Chroma, and Luminance channels individually.
            ...
            `}),z,ve),n(j,e(q,{supportItems:{"basic functionality":{js:"0.10.0",android:"2.0.1",ios:"2.0.0",macos:"0.1.0"},"`property`":{js:"0.18.0",android:"5.0.0",ios:"3.5.0",macos:"0.4.0"},"`code`":{js:"0.18.0",android:"5.0.0",ios:"3.5.0",macos:"0.4.0"},"`exponential` type":{js:"0.18.0",android:"5.0.0",ios:"3.5.0",macos:"0.4.0"},"`interval` type":{js:"0.18.0",android:"5.0.0",ios:"3.5.0",macos:"0.4.0"},"`categorical` type":{js:"0.18.0",android:"5.0.0",ios:"3.5.0",macos:"0.4.0"},"`identity` type":{js:"0.26.0",android:"5.0.0",ios:"3.5.0",macos:"0.4.0"},"`default`":{js:"0.33.0",android:"5.0.0",ios:"3.5.0",macos:"0.4.0"},"`colorSpace`":{js:"0.26.0"}}})),n(t,e(i,{get content(){return`
...
The rendered values of [color](/maplibre-style/types/#color), [number](/maplibre-style/types/#number), and [array](/maplibre-style/types/#array) properties are interpolated between stops. [Boolean](/maplibre-style/types/#boolean) and [string](/maplibre-style/types/#string) property values cannot be interpolated, so their rendered values only change at the specified stops.
