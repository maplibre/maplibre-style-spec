 ...
 * @example
 * const ll = new maplibregl.LngLat(-123.9749, 40.7736);
 * ll.lng; // = -123.9749
...
class LngLat implements ILngLat {
     ...
     * @example
     * const ll = new maplibregl.LngLat(286.0251, 40.7736);
     ...
     * @example
     * const ll = new maplibregl.LngLat(-73.9749, 40.7736);
     ...
     * @example
     * const new_york = new maplibregl.LngLat(-74.0060, 40.7128);
     * const los_angeles = new maplibregl.LngLat(-118.2437, 34.0522);
     ...
     * const ll = maplibregl.LngLat.convert(arr);
