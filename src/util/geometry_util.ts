...
export function segmentIntersectSegment(a, b, c, d) {
...
export function pointWithinPolygons(point, polygons) {
...
export function lineStringWithinPolygon(line, polygon) {
...
export function lineStringWithinPolygons(line, polygons) {
    for (let i = 0; i < polygons.length; i++) {
