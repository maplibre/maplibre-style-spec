...
describe('Validate Terrain', () => {
    test('Should return error in case terrain is not an object', () => {
        const errors = validateTerrain({ validateSpec, value: 1, styleSpec: v8, style: {} });
    ...
    test('Should return error in case terrain source is not a string', () => {
        const errors = validateTerrain({ validateSpec, value: { source: 1 }, styleSpec: v8, style: {} });
        expect(errors).toHaveLength(1);
        expect(errors[0].message).toContain('number');
    ...
    test('Should return error in case of unknown property', () => {
        const errors = validateTerrain({ validateSpec, value: { a: 1 }, styleSpec: v8, style: {} });
        expect(errors).toHaveLength(1);
        expect(errors[0].message).toContain('a');
        expect(errors[0].message).toContain('unknown');
    });
    test('Should return errors according to spec violations', () => {
        const errors = validateTerrain({ validateSpec, value: { source: 1, exaggeration: {} }, styleSpec: v8, style: {} });
    ...
    test('Should pass if everything is according to spec', () => {
        const errors = validateTerrain({ validateSpec, value: { source: 'source-id', exaggeration: 0.2 }, styleSpec: v8, style: {} });
        expect(errors).toHaveLength(0);
    });
});
//# sourceMappingURL=validate_terrain.test.js.map