...
export { Color, Padding, ParsingError, ValidationError, convertFilter, derefLayers, diffStyles as diff, expression, createFilter as featureFilter, format, styleFunction as function, v8Spec as latest, migrate, v8, validateStyle as validate, visit };
