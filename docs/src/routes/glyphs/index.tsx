...
- \`{fontstack}\` When requesting glyphs, this token is replaced with a comma separated list of fonts from a font stack specified in the [\`text-font\`](${import.meta.env.SERVER_BASE_URL}/layers/#layout-symbol-text-font) property of a symbol layer.
