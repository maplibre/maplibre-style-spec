...
`} />
            ...
            <Caption>
                <Markdown content={`
The [Vintage map style](https://blog.mapbox.com/designing-the-vintage-style-in-mapbox-studio-9da4aa2a627f) uses a custom SVG [\`background-pattern\`](${import.meta.env.SERVER_BASE_URL}/layers/#paint-background-background-pattern) to achieve a textured vintage look.
`} />
            </Caption>
...
`} />
            ...
            <Caption>
                <Markdown content={`
This map of Washington, D.C. uses the [\`fill-opacity\`](${import.meta.env.SERVER_BASE_URL}/layers/#paint-fill-fill-opacity) paint property to render a semi-transparent polygon, showing how far a person can walk from the center of the city in ten minutes.
`} />
            </Caption>
...
`} />
            ...
            <Caption>
                <Markdown content={`
This map of a [Strava](https://blog.mapbox.com/strava-launches-gorgeous-new-outdoor-maps-977c74cf37f9) user's hike through Grand Teton National Park uses the [\`line-color\`](${import.meta.env.SERVER_BASE_URL}/layers/#paint-line-line-color) and [\`line-width\`](${import.meta.env.SERVER_BASE_URL}/layers/#paint-line-line-width) paint properties to style the strong red line of the user's route.
`} />
            </Caption>
...
`} />
            ...
            <Caption>
                <Markdown content={`
This map of Denver area businesses uses the [\`icon-image\`](${import.meta.env.SERVER_BASE_URL}/layers/#layout-symbol-icon-image) layout property to use a custom image as an icon in a symbol layer.
`} />
            </Caption>
...
`} />
            ...
            <Caption>
                <Markdown content={`
This [cluster map](https://maplibre.org/maplibre-gl-js/docs/examples/cluster/) uses a circle layer with a GeoJSON data source and sets the source's [\`cluster\`](${import.meta.env.SERVER_BASE_URL}/sources/#geojson-cluster) property to \`true\` to visualize points as clusters.
`} />
            </Caption>
...
`} />
            ...
            <Caption>
                <Markdown content={`
This map uses an external dataset to provide data-driven values for the [\`fill-extrusion-height\`](${import.meta.env.SERVER_BASE_URL}/layers/#paint-fill-extrusion-fill-extrusion-height) paint property of various [country polygons](https://blog.mapbox.com/high-resolution-administrative-country-polygons-in-studio-57cf4abb0768) in a fill-extrusion layer.
`} />
            </Caption>
...
`} />
            ...
            <Caption>
                <Markdown content={`
[This visualization of earthquake data](https://maplibre.org/maplibre-gl-js/docs/examples/heatmap-layer/) uses a heatmap layer with carefully defined [paint](${import.meta.env.SERVER_BASE_URL}/layers/#paint-property) properties to highlight areas where earthquake frequency is high and many points are clustered closely together.
`} />
            </Caption>
...
`} />
            ...
            <Caption>
                <Markdown content={`
This map of Mount Shasta uses a high value for the [\`hillshade-exaggeration\`](${import.meta.env.SERVER_BASE_URL}/layers/#paint-hillshade-hillshade-exaggeration) paint property to apply an intense shading effect.
`} />
            </Caption>
