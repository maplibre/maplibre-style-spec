import{g as pe,k as t,i as o,c as i,t as me}from"./web-CPLIbZ3z.js";import{M as s}from"./markdown-CADDdR9C.js";import{s as r}from"./v8-D95HWaCp.js";import{I as a}from"./items-C4R05Hlt.js";import{S as n}from"./property-D-DeExZs.js";import"./subtitle-kxhuKEHP.js";import"./components-Da9DdH0G.js";var de=me("<div><!$><!/><!$><!/><!$><!/><!$><!/><!$><!/><!$><!/><!$><!/><!$><!/><!$><!/><!$><!/><!$><!/><!$><!/><!$><!/><!$><!/><!$><!/><!$><!/><!$><!/><!$><!/>");function _e(){const w=["vector","raster","raster-dem","geojson","image","video"];return(()=>{var e=pe(de),T=e.firstChild,[l,L]=t(T.nextSibling),k=l.nextSibling,[c,z]=t(k.nextSibling),M=c.nextSibling,[p,G]=t(M.nextSibling),N=p.nextSibling,[m,O]=t(N.nextSibling),A=m.nextSibling,[d,I]=t(A.nextSibling),J=d.nextSibling,[g,R]=t(J.nextSibling),U=g.nextSibling,[u,E]=t(U.nextSibling),B=u.nextSibling,[b,P]=t(B.nextSibling),W=b.nextSibling,[h,C]=t(W.nextSibling),D=h.nextSibling,[$,F]=t(D.nextSibling),q=$.nextSibling,[y,H]=t(q.nextSibling),K=y.nextSibling,[x,V]=t(K.nextSibling),Q=x.nextSibling,[_,X]=t(Q.nextSibling),Y=_.nextSibling,[S,Z]=t(Y.nextSibling),ee=S.nextSibling,[v,te]=t(ee.nextSibling),oe=v.nextSibling,[f,ie]=t(oe.nextSibling),se=f.nextSibling,[j,re]=t(se.nextSibling),ae=j.nextSibling,[ne,le]=t(ae.nextSibling);return o(e,i(s,{get content(){return`# Sources
...
A vector tile source. Tiles must be in [Mapbox Vector Tile format](https://github.com/mapbox/vector-tile-spec). All geometric coordinates in vector tiles must be between \`-1 * extent\` and \`(extent * 2) - 1\` inclusive. All layers that use a vector source must specify a [\`"source-layer"\`](/maplibre-style-spec/layers/#source-layer) value.
...
\`\`\`
`}),$,F),o(e,i(n,{supportItems:{"basic functionality":{js:"0.10.0",android:"2.0.1",ios:"2.0.0",macos:"0.1.0"},clustering:{js:"0.14.0",android:"4.2.0",ios:"3.4.0",macos:"0.3.0"},"line distance metrics":{js:"0.45.0",android:"6.5.0",ios:"4.4.0",macos:"0.11.0"}}}),y,H),o(e,i(a,{headingLevel:"3",get entry(){return r.source_geojson},section:"geojson"}),x,V),o(e,i(s,{content:`
## image
...
\`\`\`
`}),_,X),o(e,i(n,{supportItems:{"basic functionality":{js:"0.10.0",android:"5.2.0",ios:"3.7.0",macos:"0.6.0"}}}),S,Z),o(e,i(a,{headingLevel:"3",get entry(){return r.source_image},section:"image"}),v,te),o(e,i(s,{get content(){return`
## video
