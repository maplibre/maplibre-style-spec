...
- docs: record semiliteral support in GL JS 6.6.0 ([#1871](https://github.com/maplibre/maplibre-style-spec/pull/1871)) (by [@sargunv](https://github.com/sargunv))
## 26.4.3
### ✨ Features and improvements
...
- Fix validation and typescript types for font-faces ([#1840](https://github.com/maplibre/maplibre-style-spec/pull/1840)) (by [@HarelM](https://github.com/HarelM))
