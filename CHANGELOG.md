...
- feat: add AllPaintProperties and AllLayoutProperties ([#1579](https://github.com/maplibre/maplibre-style-spec/pull/1579)) (by [@CommanderStorm](https://github.com/CommanderStorm))
- docs: document how transitions work ([#1580](https://github.com/maplibre/maplibre-style-spec/pull/1580)) (by [@CommanderStorm](https://github.com/CommanderStorm))
- docs: make sure that visibiltiy is documented that it has global state support ([#1582](https://github.com/maplibre/maplibre-style-spec/pull/1582)) (by [@CommanderStorm](https://github.com/CommanderStorm))
## 24.8.1
### ✨ Features and improvements
